...
def getHeadPoint(mask: object) -> object:
    shape = mask.shape
...
def analyze_chessboard(image, affine_correct_flag):
    ...
    temp = chess_board_corners(dst, gray, r2)
...
def measure_distance(segmented_image: object, segmented_arm_image: object, arm_spread_image: object,
                     waist_image: object, image: object, metre_pixel_x: object,
                     metre_pixel_y: object) -> object:
    # print(metre_pixel_x)
    # print(metre_pixel_y)
...
def getSize():
    ...
    arm_spread_image = cv2.imread(filename2)

    waist_image = cv2.imread(filename3)

    affine_correct_flag = ('affine_mode')

    metre_pixel_x, metre_pixel_y, coordinate, affine_correct_parameters = analyze_chessboard(image,
                                                                                             affine_correct_flag)
